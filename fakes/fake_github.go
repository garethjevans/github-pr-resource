...
type FakeGithub struct {
	...
	ListPullRequestsStub        func([]githubv4.PullRequestState, bool, string) ([]*resource.PullRequest, error)
...
func (fake *FakeGithub) ListPullRequests(arg1 []githubv4.PullRequestState, arg2 bool, arg3 string) ([]*resource.PullRequest, error) {
...
func (fake *FakeGithub) ListPullRequestsCalls(stub func([]githubv4.PullRequestState, bool, string) ([]*resource.PullRequest, error)) {
	fake.listPullRequestsMutex.Lock()
	defer fake.listPullRequestsMutex.Unlock()
	fake.ListPullRequestsStub = stub
}

func (fake *FakeGithub) ListPullRequestsArgsForCall(i int) ([]githubv4.PullRequestState, bool, string) {
	fake.listPullRequestsMutex.RLock()
	defer fake.listPullRequestsMutex.RUnlock()
